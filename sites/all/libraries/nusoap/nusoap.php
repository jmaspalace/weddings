...
class soap_transport_http extends nusoap_base {
	...
	* @access   private
	*/
	function connect($connection_timeout=0,$response_timeout = 1000){
...
//		}
	...
	* @access   public
	*/
	function send($data, $timeout=0, $response_timeout = 1000, $cookies=NULL) {
	...
	* @deprecated
	*/
	function sendHTTPS($data, $timeout=0, $response_timeout = 1000, $cookies) {
...
class wsdl extends nusoap_base {
     ...
     * @access public 
     */
    function wsdl($wsdl = '',$proxyhost=false,$proxyport=false,$proxyusername=false,$proxypassword=false,$timeout=0,$response_timeout = 1000,$curl_options=null,$use_curl=false){
		parent::nusoap_base();
...
class nusoap_client extends nusoap_base  {
	...
	var $response_timeout = 1000;		// HTTP response timeout
	...
	* @access   public
	*/
	function nusoap_client($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 1000, $portName = ''){
		parent::nusoap_base();
	...
	* @access   private
	*/
	function send($msg, $soapaction = '', $timeout=0, $response_timeout = 1000) {
		$this->checkCookies();
		// detect transport
		switch(true){
			// http(s)
