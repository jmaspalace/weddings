...
<section class="container-fluid bloque-form">
		<div class="container">
			<h2 class="titulo_bloque text-center"><?php print $node->field_descripcion_corta['und'][0]['value'] ?></h2>
			<?php
				if ($node->field_resort['und'][0]['tid']==1 || $node->field_resort['und'][0]['tid']==133) {
